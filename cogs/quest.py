...
def _build_bar(ratio: float) -> str:
    """
    Classic line bar of BAR_LEN segments.
    Filled portion: green if done, else red while in progress.
    Empty portion: white.
    """
    ...
    # In-progress fill uses red (progress2); remainder white (progress1)
    return (almost * filled) + (empty * (BAR_LEN - filled))
