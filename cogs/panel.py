...
from functions import get_tester_role_id, active_games, is_maintenance_mode, stats_col, MAINTENANCE_DOC_ID, is_op
...
class GuideButtonView(discord.ui.View):
    def __init__(self):
        ...
        names = [
            ...
            ("Fake Streak", "Assign client-side fake streaks to target userIDs. Only those users see it on `.lb`."),
    ...
    async def guide_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                "• **Fake Streak** — client-side streak for targets only\n"
                "• **Guide** — this menu"
            ),
            color=0x2f3136,
        )
